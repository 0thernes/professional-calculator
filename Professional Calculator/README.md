...
[![tests](https://img.shields.io/badge/tests-1073%20passing-brightgreen)](#testing)
...
- **Every algorithm is anchored to a closed-form check in the test suite.** Not "looks plausible" — `det(AB) = det(A)·det(B)`, eigenvalues of a rotation matrix come back `±i`, `∫₀^π sin x dx = 2`, `Φ(1.96) = 0.975`, Black–Scholes obeys put–call parity. 1073 tests, all green.
...
| **STEM Lab** | paged live-SVG visual panel (10 cyclable scientific visualizations) | [`stem.js`](stem.js) |
...
```
36 test suites · 1073 tests · 100% pass
