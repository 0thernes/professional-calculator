...
[![tests](https://img.shields.io/badge/tests-950%20passing-brightgreen)](#testing)
...
- **Every algorithm is anchored to a closed-form check in the test suite.** Not "looks plausible" — `det(AB) = det(A)·det(B)`, eigenvalues of a rotation matrix come back `±i`, `∫₀^π sin x dx = 2`, `Φ(1.96) = 0.975`, Black–Scholes obeys put–call parity. 950 tests, all green.
...
| **STEM Lab** | paged live-SVG visual panel (9 cyclable scientific visualizations) | [`stem.js`](stem.js) |
...
```
31 test suites · 950 tests · 100% pass
